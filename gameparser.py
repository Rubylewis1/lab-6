...
def normalise_input(user_input):
    ...
    """
    no_punct = remove_punct(user_input).lower() #removes punc and chamges to lowercase
    words = no_punct.split()  #split the string into words
    important_words = filter_words(words, skip_words)  #filter out the skip words
